...
<body class="flex min-h-screen bg-gray-100">
  <!-- Sidebar -->
    <div id="sidebar" class="w-64 bg-gray-900 text-white p-5 space-y-4 transform transition-transform duration-300 md:translate-x-0 -translate-x-full fixed md:relative z-50 h-screen">
      ...
      <nav class="space-y-2">
        <a href="<?php echo e(route('categories.index')); ?>" class="block p-2 rounded hover:bg-gray-700 <?php echo e(Route::is('categories.*') ? 'bg-gray-700' : ''); ?>">Categories</a>
        <a href="<?php echo e(route('posts.index')); ?>" class="block p-2 rounded hover:bg-gray-700 <?php echo e(Route::is('posts.*') ? 'bg-gray-700' : ''); ?>">Posts</a>
      </nav>
    </div>
        ...
        <div id="dropdown" class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg hidden">
          <ul class="py-2">
            <li>
              ...
              <form action="<?php echo e(route('logout')); ?>" method="post" class="p-3 inlineblock px-4 py-2 text-gray-700 hover:bg-gray-200">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\USER\Desktop\Ostad Classes\PHP_BATCH6\M22_C3\blog-project\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>